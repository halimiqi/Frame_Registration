...
def GetAllXY():
    ...
    for index in range(0, 10000):
        sitkImage = sitk.ReadImage(os.path.join(os.path.abspath("."), "RawData_transZ", "NrrdData", "%d.nrrd" % index))
    ...
    dataY = np.load(os.path.join(os.path.abspath("."), "RawData_transZ" , "transformArray", "transform.npy"))
    # dataY2 = np.load(
    ...
    np.save(os.path.join(os.path.abspath("."), "RawData_transZ","AllData", "Locs.npy"), ImageLocs)
    np.save(os.path.join(os.path.abspath("."), "RawData_transZ","AllData", "trasform.npy"), dataY)
    return ImageLocs, dataY

def GetBatchAndSave(mean, std):
    batchSize = 100
    DataX = np.load(os.path.join(os.path.abspath("."), "RawData_transZ", "AllData", "Locs.npy"))
    DataY = np.load(os.path.join(os.path.abspath("."), "RawData_transZ", "AllData", "trasform.npy"))
    ...
    testX = np.divide(dataX, 255)
    testY = (dataY - mean) / std

    np.save(os.path.join(os.path.abspath("."), "RawData_transZ", "testData", "testX.npy"), testX)
    np.save(os.path.join(os.path.abspath("."), "RawData_transZ", "testData", "testY.npy"), testY)
...
def ReadTestData():
    dataX =  np.load(os.path.join(os.path.abspath("."), "SummarizeAndPlot", "RawData_transZ","testData", "testX.npy"))
    dataY = np.load(os.path.join(os.path.abspath("."), "SummarizeAndPlot", "RawData_transZ", "testData", "testY.npy"))
    mean = np.load(
